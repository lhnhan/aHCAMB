    ...
    type, extends (TCAMBParameters) :: CAMBparams
        ...
        !!Nhan!!
        real(dl)  :: k_plot = 1.e-4_dl !Plotting wavenumber
		real(dl)  :: meR = 1._dl !electron ratio at recombination and present day
        real(dl)  :: omah2 = 0._dl !axion density Omega_a h^2
		!!!!!!!!
        ...
        !!Nhan!!
        class(TAxionModel), allocatable :: Axion
        !!!!!!!!
